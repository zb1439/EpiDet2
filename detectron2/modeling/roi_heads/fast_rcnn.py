...
class CosineSimOutputLayers(nn.Module):
    def __init__(self, cfg, input_size):
        ...
        self.cls_agnostic_bbox_reg = cfg.MODEL.ROI_BOX_HEADS.CLS_AGNOSTIC_BBOX_REG
        self.smooth_l1_beta = cfg.MODEL.ROI_BOX_HEADS.SMOOTH_L1_BETA
        ...
        self.box_reg_loss_weight = cfg.MOEDL.ROI_BOX_HEAD.BBOX_REG_LOSS_WEIGHT
        ...
        self.box_dim = 4
        self.bbox_pred = nn.Linear(input_size, num_bbox_reg_classes * self.box_dim)
