...
def load_coco_json(json_file, image_root, dataset_name=None, extra_annotation_keys=['segmentation']):
    """
    ...
    coco_category_info[json_file] = coco_cat2idx = {}
    timer = Timer()
...
"""
    ...
    for image_ix, (img_dict, anno_dict_list) in enumerate(imgs_anns):
        ...
        for anno in anno_dict_list:
            ...
            # Add to cat2idx, note that cats are unmapped (not continuous)
            if obj["category_id"] not in coco_cat2idx:
                coco_cat2idx[obj["category_id"]] = set()
            coco_cat2idx[obj["category_id"]].add(image_ix)
...
def convert_to_coco_json(dataset_name, output_file, allow_cached=True):
    ...
    # FIXME: this function is inconsistent with fsdet
