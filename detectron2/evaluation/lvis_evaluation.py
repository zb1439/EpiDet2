...
class LVISEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        if self._distributed:
            ...
            self._predictions = list(itertools.chain(*sself._predictions))
        ...
        if "proposals" in self._predictions[0]:
            self._eval_box_proposals(self._predictions)
        if "instances" in self._predictions[0]:
            self._eval_predictions(set(self._tasks), self._predictions)
