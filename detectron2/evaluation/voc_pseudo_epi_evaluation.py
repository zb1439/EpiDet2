...
from detectron2.data.datasets.builtin_meta import _get_coco_fewshot_instances_meta

THING_CLASSES = ['person', 'bird', 'cat', 'cow', 'dog', 'horse',
        ...
        if not self._is_splits:
            for task in sorted(tasks):
                ...
                res = self._derive_coco_results(
                    coco_eval, task, class_names=THING_CLASSES
                )
        ...
        # Few-Shot detection evaluation
            ...
            for split, classes, names in [
                ...
                res_ = self._derive_coco_results(
                    coco_eval, "bbox", class_names=THING_CLASSES,
                )
                res = {}
